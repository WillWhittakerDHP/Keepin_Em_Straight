INSERT INTO humanity (humanity_id, humanity_type)
VALUES  (0, 'Human'),
        (1, 'Cylon'),
        (2, 'Hybrid'),
        (3, 'Deceased'),
...
VALUES  (000, 'Command Officer', 100000, 10),
...
INSERT INTO employee (first_name, last_name, humanity_id, division_id, role_id, commander_id)
VALUES ('William', 'Adama', 1, 00, 000,)
('Lee', 'Adama', 1, 50, 800)
